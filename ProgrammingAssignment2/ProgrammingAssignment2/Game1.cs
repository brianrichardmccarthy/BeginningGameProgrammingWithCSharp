    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > ChangeDelayTime)
            {
                ...
                // get a new int betweenn 0 and 2
                ...
                // change the length and width of the rentangle to the current sprite
            ...
            // add the speedX to the drawRectangle X
            drawRectangle.X += speedX;

            // add the speedY to the drawRectangle Y
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // draw the current sprite in the retangle
