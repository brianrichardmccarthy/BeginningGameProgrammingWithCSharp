...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // add a new burger object at half the width of the window and one eigth of the height of the window
        ...
        private void SpawnBear()
        {
            ...
            int location = GetRandomLocation(GameConstants.SpawnBorderSize, GameConstants.WindowWidth - GameConstants.SpawnBorderSize);
            ...
            // vector for the bear to move
            // I think its wrong, i just wanted it to move
            Vector2 velocity = new Vector2(speed * (float) Math.Cos(angle),
                speed * (float) Math.Sin(angle));

            // create new bear
            TeddyBear bear = new TeddyBear(Content, @"graphics\teddybear", GameConstants.WindowWidth / 2, GameConstants.WindowHeight / 2, velocity, null, null);
