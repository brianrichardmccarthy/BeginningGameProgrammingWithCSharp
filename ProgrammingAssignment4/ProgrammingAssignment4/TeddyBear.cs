    ...
    public class TeddyBear {
        ...
        public TeddyBear(Texture2D sprite, Vector2 location) {
            ...
            drawRectangle = new Rectangle((int) (location.X - sprite.Width / 2),
                (int) (location.Y - sprite.Height / 2), sprite.Width,
                sprite.Height);
        ...
        public void Update(GameTime gameTime, MouseState mouse) {
            ...
            /*
                ...
                Instead, you should update the location field in the TeddyBear class 
                using velocity and elapsed game time, 
                then center the drawRectangle field on the location X and Y values. 
                Although your draw rectangle could end up off by a single pixel 
                in both X and Y on a particular update, 
                it will never be worse than that because the location 
                field doesn't suffer from the accumulated rounding 
                (because X and Y in the location field are floats).
